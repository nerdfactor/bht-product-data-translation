insert into "currency" ("name", "normalized", "symbol") values ('Euro', 'Euro', '€');
insert into "currency" ("name", "normalized", "symbol") values ('Dollar', 'Dollar', '$');
insert into "currency" ("name", "normalized", "symbol") values ('ČБългарски лев', 'Bulgarischer Lew', 'лв');
insert into "currency" ("name", "normalized", "symbol") values ('Česká koruna','Tschechische Krone', 'Kč');
insert into "currency" ("name", "normalized", "symbol") values ('Danske krone', 'Dänische Krone', 'kr');
insert into "currency" ("name", "normalized", "symbol") values ('Pound', 'Pfund', '£');
insert into "currency" ("name", "normalized", "symbol") values ('Forint', 'Forint', 'Ft');
insert into "currency" ("name", "normalized", "symbol") values ('Rupiah', 'Rupiah', 'Rp');
insert into "currency" ("name", "normalized", "symbol") values ('円', 'Yen', '¥');
insert into "currency" ("name", "normalized", "symbol") values ('원', 'Won', '₩');
insert into "currency" ("name", "normalized", "symbol") values ('Norsk krone', 'Norwegische Krone', 'kr');
insert into "currency" ("name", "normalized", "symbol") values ('Złoty', 'Złoty', 'zł');
insert into "currency" ("name", "normalized", "symbol") values ('Leu', 'Leu', 'lei');
insert into "currency" ("name", "normalized", "symbol") values ('Рубль', 'Rubel', '₽');
insert into "currency" ("name", "normalized", "symbol") values ('Svenska krona', 'Schwedische Krone', 'kr');
insert into "currency" ("name", "normalized", "symbol") values ('Türk lirası', 'Lira', '₺');
insert into "currency" ("name", "normalized", "symbol") values ('Гривня', 'Hrywnja', '₴');
insert into "currency" ("name", "normalized", "symbol") values ('人民币', 'Yuan', '¥');
